jQuery(function(t){var e=function(){var e=("https:"==location.protocol?"https:":"http:")+"//newfreesongs.com/subscribe",a=function(){var e=(/MSIE (\d+)\./.exec(navigator.userAgent)||[0,0])[1]
...
e.error?o.reject(e.error):o.resolve(e.response)}catch(a){o.reject("Incorrect server response.")}}).fail(function(){var t="Failed to queryrrrrrrrrrr the server. "
t+="onLine"in navigator&&!navigator.onLine?"No connectionssssssssssssss to the Internet.":"Check the connection and try again.",o.reject(t)}),o)},{Form:function(t){return new i(t)}}}(),a=function(e){if(e.checkValidity)return e.checkValidity()
